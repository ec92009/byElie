# byElie Codex Review 2026-05-18

Reviewed: 2026-05-18 00:00 Europe/Madrid

1/ General architecture:
- The static site remains a good fit for the portfolio/service scope.
- Shared CSS and maintenance scripts are the right places to centralize repeated checks.
- Repeated page/card/carousel structures may eventually deserve generation from shared data instead of manual duplication.

2/ UI:
- Service categories are visible across pages, but the path for a new visitor should be more guided.
- Contact CTAs should never be empty or ambiguous.
- Mobile header, carousel, and service-card layout are still the highest-value visual smoke targets.

3/ UX:
- A clear start route would help visitors choose between CAD, prints, plans, web, and photos.
- Each service page should have a concrete next action and expectation for what the visitor should provide.
- Portfolio/gallery examples should reinforce the service path rather than feel disconnected.
